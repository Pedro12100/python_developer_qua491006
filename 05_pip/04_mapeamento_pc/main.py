...
print(f"Nome do úsuario: {os.environ.get('USERNAME')}")
...
only_udp = [conn for conn in psutil.net_connections(kind='udp') if conn.type == socket.SOCK_DGRAM]

# separar as informações de portas TCP e UDP
